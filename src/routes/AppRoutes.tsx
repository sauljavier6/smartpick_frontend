...
import GoUpcLayout from "../components/Layouts/GoUpcLayout";
import GoUpcPage from "../pages/goupc/GoUpcPage";
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      {/* Uva */}
      <Route path="/goupc" element={<GoUpcLayout />}>
        <Route index element={<GoUpcPage />} />
      </Route>
